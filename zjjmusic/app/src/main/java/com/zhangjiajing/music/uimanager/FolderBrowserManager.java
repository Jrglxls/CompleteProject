...
public class FolderBrowserManager extends MainUIManager implements IConstants,
	...
	public FolderBrowserManager(Activity activity, ViewPager manager) {
	...
	public View getView() {
		View folderView = mInflater.inflate(R.layout.folderbrowser, null);
		initBg(folderView);
		initView(folderView);
		return folderView;
	}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = mActivity.getLayoutInflater().inflate(
						R.layout.folderbrowser_listitem, null);
