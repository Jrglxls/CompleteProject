...
import com.zhangjiajing.music.fragment.MenuScanFragment;
...
public class MenuSlideActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		setContentView(R.layout.menu_slide);//设置视图menu_slide
	...
	private void initViewPager() {
		...
		Fragment menuFragment = new MenuScanFragment();//歌曲扫描fragment
