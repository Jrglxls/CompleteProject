...
import com.zhangjiajing.music.slidemenu.SlidingMenu.OnClosedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	/**
	 * 活动指针的ID。这是用来在使用多个指针中拖动/甩保留一致性。
	 */
	protected int mActivePointerId = INVALID_POINTER;
	/**
	 * 由{@link#mActivePointerId}无当前活动pointer.Used哨兵值。
	 */
	...
	public interface OnPageChangeListener {
		...
		/**
		 *当电流页面滚动该方法将被调用，无论是作为一个编程启动平稳滚动的一部分，或用户发起的触摸滚动。
		 *
