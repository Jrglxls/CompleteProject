...
import com.zhangjiajing.music.activity.MainContentActivity.OnBackListener;
 ...
 */
public class ViewPager implements IConstants, OnBackListener {
	...
	private android.support.v4.view.ViewPager mViewPager, mViewPagerSub;
	...
	public ViewPager(Activity activity, View view) {
	...
	private void init() {
		...
		mViewPagerSub = (android.support.v4.view.ViewPager) findViewById(R.id.viewPagerSub);
	...
	private class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int arg0) {
			...
			if (onPageScrolled == 0 && arg0 == 0) {
				mMainActivity.unRegisterBackListener(ViewPager.this);
				mViewPager.removeAllViews();
