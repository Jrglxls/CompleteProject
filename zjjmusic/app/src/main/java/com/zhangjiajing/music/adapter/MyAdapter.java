...
import com.zhangjiajing.music.interfaces.IQueryFinished;
...
public class MyAdapter extends BaseAdapter implements IConstants {
	...
	public MyAdapter(Context context, ServiceManager sm, MusicPlayManager sdm) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mLayoutInflater.inflate(R.layout.musicbrowser_listitem, null);
