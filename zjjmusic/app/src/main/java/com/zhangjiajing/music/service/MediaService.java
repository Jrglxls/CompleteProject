...
import com.zhangjiajing.music.shake.ShakeDetector;
import com.zhangjiajing.music.shake.ShakeDetector.OnShakeListener;
	...
	private class MusicPlayBroadcast extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (intent.getAction().equals(BROADCAST_NAME)) {
				...
				mShake = intent.getBooleanExtra(SHAKE_ON_OFF, true);
