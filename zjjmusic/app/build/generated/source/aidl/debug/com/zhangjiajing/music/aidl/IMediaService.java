...
public static abstract class Stub extends android.os.Binder implements com.zhangjiajing.music.aidl.IMediaService
{
private static final java.lang.String DESCRIPTOR = "com.zhangjiajing.music.aidl.IMediaService";
...
/**
 * Cast an IBinder object into an com.zhangjiajing.music.aidl.IMediaService interface,
 * generating a proxy if needed.
 */
public static com.zhangjiajing.music.aidl.IMediaService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.zhangjiajing.music.aidl.IMediaService))) {
return ((com.zhangjiajing.music.aidl.IMediaService)iin);
}
return new com.zhangjiajing.music.aidl.IMediaService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.zhangjiajing.music.model.MusicInfo> _arg0;
_arg0 = data.createTypedArrayList(com.zhangjiajing.music.model.MusicInfo.CREATOR);
...
data.enforceInterface(DESCRIPTOR);
java.util.List<com.zhangjiajing.music.model.MusicInfo> _arg0;
_arg0 = new java.util.ArrayList<com.zhangjiajing.music.model.MusicInfo>();
...
{
data.enforceInterface(DESCRIPTOR);
com.zhangjiajing.music.model.MusicInfo _result = this.getCurMusic();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.zhangjiajing.music.aidl.IMediaService
{
...
@Override public void refreshMusicList(java.util.List<com.zhangjiajing.music.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void getMusicList(java.util.List<com.zhangjiajing.music.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_reply.readException();
_reply.readTypedList(musicList, com.zhangjiajing.music.model.MusicInfo.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public com.zhangjiajing.music.model.MusicInfo getCurMusic() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.zhangjiajing.music.model.MusicInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurMusic, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.zhangjiajing.music.model.MusicInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public void refreshMusicList(java.util.List<com.zhangjiajing.music.model.MusicInfo> musicList) throws android.os.RemoteException;
public void getMusicList(java.util.List<com.zhangjiajing.music.model.MusicInfo> musicList) throws android.os.RemoteException;
...
public com.zhangjiajing.music.model.MusicInfo getCurMusic() throws android.os.RemoteException;
}
